class Ezasm < Formula
  ...
  url "https://github.com/michaelschuff/EzASM/archive/refs/tags/v#{version}.tar.gz"
  ...
  def install
    ...
    bin.write_jar_script libexec/"ezasm-#{version}-beta-full.jar", "ezasm", java_version: "17"
  end
